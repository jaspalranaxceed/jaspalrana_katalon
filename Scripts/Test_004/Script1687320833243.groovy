...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input'), 'test')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Status'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus o_d4f516'), 'testt')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_oxd-input oxd-input--active'), 'hUKwJTbofgPU9eVlw/CnDQ==')
